    ...
    if is_secff:
        ...
        return OrderedDict(
            [
                ...
                ("loss_rrpn_cls", AverageMeter(string_format="%6.3lf")),
                ("loss_rrpn_bbox", AverageMeter(string_format="%6.3lf")),
                ...
                ("loss_kptpose", AverageMeter(string_format="%6.3lf")),
                ("loss_kptobj", AverageMeter(string_format="%6.3lf")),
                ("loss_rkeypts", AverageMeter(string_format="%6.3lf")),
                ("loss_rkeypts_obj", AverageMeter(string_format="%6.3lf")),
                ("loss_rkeypts_score", AverageMeter(string_format="%6.3lf")),
